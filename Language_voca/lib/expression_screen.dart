...
class ExpressionScreen extends StatefulWidget {
  ...
  const ExpressionScreen({super.key, this.collectionName}); // Updated constructor
...
class _ExpressionScreenState extends State<ExpressionScreen> {
  ...
  void initState() {
    super.initState();
    _vocabularyCollection = FirebaseFirestore.instance.collection('languages').doc('English').collection(widget.collectionName ?? 'expression'); // Use collectionName or default
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: _isSearchActive
            ...
            : Text("Expressions", style: GoogleFonts.poppins()),
        leading: IconButton(
