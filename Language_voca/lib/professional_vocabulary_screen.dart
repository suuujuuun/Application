...
class ProfessionalVocabularyScreen extends StatefulWidget {
  final String? collectionName;
  const ProfessionalVocabularyScreen({super.key, this.collectionName});

  @override
  State<ProfessionalVocabularyScreen> createState() => _ProfessionalVocabularyScreenState();
}

class _ProfessionalVocabularyScreenState extends State<ProfessionalVocabularyScreen> {
  ...
  void initState() {
    super.initState();
    // professional vocabulary를 languages/English 하위 professional_vocabulary 컬렉션으로 설정
    _vocabularyCollection = FirebaseFirestore.instance
        .collection('languages')
        .doc('English')
        .collection('professional_vocabulary');
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: _isSearchActive
            ...
            : Text("Professional Vocabulary", style: GoogleFonts.poppins()),
        leading: IconButton(
      ...
      body: SizedBox.expand(
        child: VocabularyGraphView(
          ...
          collectionName: 'professional_vocabulary',
        ),
      ),
