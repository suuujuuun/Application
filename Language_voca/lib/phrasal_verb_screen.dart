...
class PhrasalVerbScreen extends StatefulWidget {
  final String? collectionName; // New parameter
  const PhrasalVerbScreen({super.key, this.collectionName}); // Updated constructor

  @override
  State<PhrasalVerbScreen> createState() => _PhrasalVerbScreenState();
}

class _PhrasalVerbScreenState extends State<PhrasalVerbScreen> {
  ...
  void initState() {
    super.initState();
    _vocabularyCollection = FirebaseFirestore.instance.collection('languages').doc('English').collection(widget.collectionName ?? 'phrasal_verb'); // Use collectionName or default
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: _isSearchActive
            ...
            : Text("Phrasal Verbs", style: GoogleFonts.poppins()),
        leading: IconButton(
      ...
      body: SizedBox.expand(
        child: VocabularyGraphView(language: 'English', searchQuery: _searchQuery, collectionName: widget.collectionName), // Pass collectionName
      ),
